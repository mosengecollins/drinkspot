...
print ("<h1>total command <b>$commandTotal</b></h1>");
...
print ("<form action='selectUpdateCommandPaid.php' method='post'> ");
    
print ("<input type='text' name= 'commandPaid' value=$commandTotal />");
